            ...
            <div class="carousel-item active" style="background-image: url(assets/img/slide-1.jpg)">
                <div class="container">
                    ...
                    <p>Memberikan kontribusi bagi pengembangkan usaha peternakan sapi perah kerakyatan dan mempromosikan
                        ...
                        peternak.</p>
                    <a href="#about" class="btn-get-started scrollto">Diagnosa Sapi</a>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="tab-content">
                        <div class="tab-pane active show" id="tab-1">
                            ...
                            <img src="<?= base_url(); ?>assets/img/departments-1.jpg" alt="" class="img-fluid">
                        ...
                        <div class="tab-pane" id="tab-2">
                            ...
                            <p class="fst-italic">Qui laudantium consequatur laborum sit qui ad sapiente dila parde
                                sonata raqer a videna mareta paulona marka</p>
                            <img src="<?= base_url(); ?>assets/img/departments-2.jpg" alt="" class="img-fluid">
                            <p>Et nobis maiores eius. Voluptatibus ut enim blanditiis atque harum sint. Laborum eos
                                ipsum ipsa odit magni. Incidunt hic ut molestiae aut qui. Est repellat minima
                                eveniet eius et quis magni nihil. Consequatur dolorem quaerat quos qui similique
                                accusamus nostrum rem vero</p>
                        ...
                        <div class="tab-pane" id="tab-3">
                            ...
                            <p class="fst-italic">Qui laudantium consequatur laborum sit qui ad sapiente dila parde
                                sonata raqer a videna mareta paulona marka</p>
                            <img src="<?= base_url(); ?>assets/img/departments-3.jpg" alt="" class="img-fluid">
                            <p>Et nobis maiores eius. Voluptatibus ut enim blanditiis atque harum sint. Laborum eos
                                ipsum ipsa odit magni. Incidunt hic ut molestiae aut qui. Est repellat minima
                                eveniet eius et quis magni nihil. Consequatur dolorem quaerat quos qui similique
                                accusamus nostrum rem vero</p>
                        ...
                        <div class="tab-pane" id="tab-4">
                            ...
                            <p class="fst-italic">Qui laudantium consequatur laborum sit qui ad sapiente dila parde
                                sonata raqer a videna mareta paulona marka</p>
                            <img src="<?= base_url(); ?>assets/img/departments-4.jpg" alt="" class="img-fluid">
                            <p>Et nobis maiores eius. Voluptatibus ut enim blanditiis atque harum sint. Laborum eos
                                ipsum ipsa odit magni. Incidunt hic ut molestiae aut qui. Est repellat minima
                                eveniet eius et quis magni nihil. Consequatur dolorem quaerat quos qui similique
                                accusamus nostrum rem vero</p>
            ...
            <div class="gallery-slider swiper">
                <div class="swiper-wrapper align-items-center">
                    <div class="swiper-slide"><a class="gallery-lightbox"
                            href="<?= base_url(); ?>assets/img/gallery/gallery-1.jpg"><img
                                src="<?= base_url(); ?>assets/img/gallery/gallery-1.jpg" class="img-fluid" alt=""></a>
                    </div>
                    <div class="swiper-slide"><a class="gallery-lightbox"
                            href="<?= base_url(); ?>assets/img/gallery/gallery-2.jpg"><img
                                src="<?= base_url(); ?>assets/img/gallery/gallery-2.jpg" class="img-fluid" alt=""></a>
                    </div>
                    <div class="swiper-slide"><a class="gallery-lightbox"
                            href="<?= base_url(); ?>assets/img/gallery/gallery-3.jpg"><img
                                src="<?= base_url(); ?>assets/img/gallery/gallery-3.jpg" class="img-fluid" alt=""></a>
                    </div>
                    <div class="swiper-slide"><a class="gallery-lightbox"
                            href="<?= base_url(); ?>assets/img/gallery/gallery-4.jpg"><img
                                src="<?= base_url(); ?>assets/img/gallery/gallery-4.jpg" class="img-fluid" alt=""></a>
                    </div>
                    <div class="swiper-slide"><a class="gallery-lightbox"
                            href="<?= base_url(); ?>assets/img/gallery/gallery-5.jpg"><img
                                src="<?= base_url(); ?>assets/img/gallery/gallery-5.jpg" class="img-fluid" alt=""></a>
                    </div>
                    <div class="swiper-slide"><a class="gallery-lightbox"
                            href="<?= base_url(); ?>assets/img/gallery/gallery-6.jpg"><img
                                src="<?= base_url(); ?>assets/img/gallery/gallery-6.jpg" class="img-fluid" alt=""></a>
                    </div>
                    <div class="swiper-slide"><a class="gallery-lightbox"
                            href="<?= base_url(); ?>assets/img/gallery/gallery-7.jpg"><img
                                src="<?= base_url(); ?>assets/img/gallery/gallery-7.jpg" class="img-fluid" alt=""></a>
                    </div>
                    <div class="swiper-slide"><a class="gallery-lightbox"
                            href="<?= base_url(); ?>assets/img/gallery/gallery-8.jpg"><img
                                src="<?= base_url(); ?>assets/img/gallery/gallery-8.jpg" class="img-fluid" alt=""></a>
                    </div>
                </div>
