          ...
          <div class="container-fluid">
              <div class="alert alert-secondary" role="alert">
                  <i class="nav-icon fas fa-chart-line"></i> Dashboard &nbsp; &nbsp; > &nbsp; &nbsp; <i
                      class="nav-icon fas fa-newspaper"></i> Berita
              </div>
              <div class="row">
                  <div class="col">
                      <!-- Tabel -->
                          ...
                          <div class="card-body">
                              ...
                              <table id="tabel" class="table table-bordered">
                                  ...
                                  <tbody>
                                      ...
                                      <tr>
                                          <td><?= $no++ ?></td>
                                          <td style="width:200px"><?= $brt->judul_berita ?></td>
                                          </td>
                                          <td style="width:500px"><?= $brt->keterangan_berita ?></td>
                                          <td style="width:200px"><img
                                                  src="<?= base_url('assets/FotoBerita/') . $brt->foto_berita ?>"
                                          ...
                                          <td style="width:180px">
                                              ...
                                              <a class='btn btn-info'
                                                  href='<?= base_url() . 'Admin/berita/detail/' . $brt->id_berita ?>'
                                                  class='btn btn-biru'>
